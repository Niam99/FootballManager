...
#+CAPTION: Clock summary at [2018-02-14 Wed 10:19]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *70:39* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 70:39   |       |      | 100.0 |
| Active                                                                      |         | 70:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   1.4 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   2.2 |
...
| COMPLETED Build main                                                        |         |       | 2:10 |   3.1 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.7 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.2 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.4 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   2.6 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.4 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.5 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   2.8 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.1 |
...
| COMPLETED Research classes                                                  |         |       | 2:56 |   4.2 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   3.3 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.6 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.4 |
...
| COMPLETED Pointers - research                                               |         |       | 1:30 |   2.1 |
...
| COMPLETED Research parts of code                                            |         |       | 0:33 |   0.8 |
