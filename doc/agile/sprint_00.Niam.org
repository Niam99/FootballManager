...
#+CAPTION: Clock summary at [2018-02-01 Thu 15:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:18* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:18   |       |      | 100.0 |
| Active                                                                      |         | 24:18 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   4.0 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   6.3 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.9 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   1.4 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   4.5 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   2.3 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.8 |
| COMPLETED Build main                                                        |         |       | 2:10 |   8.9 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   2.1 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   3.6 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   6.9 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   7.5 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.3 |
| COMPLETED Create players class                                              |         |       | 0:21 |   1.4 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   8.2 |
| STARTED create setup function in player class                               |         |       | 1:30 |   6.2 |
| STARTED create display function in player class                             |         |       | 0:20 |   1.4 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   4.1 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   4.6 |
| Research classes                                                            |         |       | 2:56 |  12.1 |
| Dealing with conflicts in magit                                             |         |       | 2:19 |   9.5 |
