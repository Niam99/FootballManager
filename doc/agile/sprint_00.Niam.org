...
#+CAPTION: Clock summary at [2018-02-08 Thu 14:23]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Practice branches                                                 |         |       | 1:05 |   2.1 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.0 |
| COMPLETED Create main                                                       |         |       | 0:26 |   0.8 |
| COMPLETED Build main                                                        |         |       | 2:10 |   4.1 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.0 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.6 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.2 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.5 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.6 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.7 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.8 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.9 |
...
| COMPLETED Research classes                                                  |         |       | 2:56 |   5.6 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   4.4 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.8 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.2 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.9 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.5 |
...
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.3 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.8 |
...
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   2.2 |
