...
#+CAPTION: Clock summary at [2018-02-09 Fri 11:56]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *56:32* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 56:32   |       |      | 100.0 |
| Active                                                                      |         | 56:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   1.7 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   2.7 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   0.8 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.6 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   1.9 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.0 |
| COMPLETED Create main                                                       |         |       | 0:26 |   0.8 |
| COMPLETED Build main                                                        |         |       | 2:10 |   3.8 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.9 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.5 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.0 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.2 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.6 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.6 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.5 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.7 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.6 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.8 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.0 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   5.2 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   4.1 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.8 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.0 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.8 |
...
| COMPLETED Testing program                                                   |         |       | 1:00 |   1.8 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   1.8 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   2.7 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   1.8 |
...
| COMPLETED Review pointers                                                   |         |       | 1:00 |   1.8 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   1.8 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.7 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.6 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   1.8 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.0 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.3 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.2 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.1 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.7 |
| COMPLETED Split employee program up                                         |         |       | 1:14 |   2.2 |
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   0.8 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   1.9 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.7 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   2.0 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.8 |
| COMPLETED Help PG split files                                               |         |       | 0:28 |   0.8 |
| COMPLETED Class constructor and multiple files Video                        |         |       | 0:54 |   1.6 |
| COMPLETED Make another object                                               |         |       | 0:23 |   0.7 |
| COMPLETED Allow user to add employee/object                                 |         |       | 0:56 |   1.7 |
| COMPLETED Discuss tasks                                                     |         |       | 0:30 |   0.9 |
| COMPLETED Research tasks                                                    |         |       | 0:36 |   1.1 |
| COMPLETED Watch classes video                                               |         |       | 0:53 |   1.6 |
| Employee IO program                                                         |         |       | 1:03 |   1.9 |
