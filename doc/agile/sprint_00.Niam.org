...
#+CAPTION: Clock summary at [2018-02-13 Tue 10:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Build main                                                        |         |       | 2:10 |   3.3 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.8 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.3 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.6 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   2.8 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.5 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.5 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.1 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.3 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.5 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.5 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   1.7 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   4.5 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   3.5 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.7 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.6 |
...
| COMPLETED Pointers - research                                               |         |       | 1:30 |   2.3 |
...
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   1.8 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.4 |
| COMPLETED Split employee program up                                         |         |       | 1:14 |   1.9 |
...
| COMPLETED Employee IO program                                               |         |       | 1:03 |   1.6 |
...
| COMPLETED Discuss tasks                                                     |         |       | 0:30 |   0.8 |
| COMPLETED Review changes                                                    |         |       | 1:06 |   1.7 |
| COMPLETED Add more team data to league                                      |         |       | 0:37 |   0.9 |
| COMPLETED Testing                                                           |         |       | 1:02 |   1.6 |
| COMPLETED Review code/research tasks                                        |         |       | 1:01 |   1.6 |
