...
#+CAPTION: Clock summary at [2018-01-31 Wed 15:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *17:56* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 17:56   |       |      | 100.0 |
| Active                                                                      |         | 17:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   5.4 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   8.6 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   2.6 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   2.0 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   6.0 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   3.1 |
| COMPLETED Create main                                                       |         |       | 0:26 |   2.4 |
| COMPLETED Build main                                                        |         |       | 2:10 |  12.1 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   2.9 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   4.8 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   9.4 |
| POSTPONED Research classes                                                  |         |       | 1:49 |  10.1 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.8 |
| COMPLETED Create players class                                              |         |       | 0:21 |   2.0 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |  11.2 |
| STARTED create setup function in player class                               |         |       | 1:30 |   8.4 |
| STARTED create display function in player class                             |         |       | 0:20 |   1.9 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   5.6 |
