...
#+CAPTION: Clock summary at [2018-02-07 Wed 12:15]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 45:31   |       |      | 100.0 |
| Active                                                                      |         | 45:31 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   2.1 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   3.4 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.0 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.8 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   2.4 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.2 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.0 |
| COMPLETED Build main                                                        |         |       | 2:10 |   4.8 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.1 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.9 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.7 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   4.0 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.7 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.8 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   4.4 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.3 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.7 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   2.2 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.5 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   6.4 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   5.1 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.0 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.7 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   2.2 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.7 |
| COMPLETED Show detail of select player only                                 |         |       | 0:29 |   1.1 |
| COMPLETED Discuss task                                                      |         |       | 0:33 |   1.2 |
| COMPLETED Add the rest of the players                                       |         |       | 0:39 |   1.4 |
| COMPLETED Testing program                                                   |         |       | 1:00 |   2.2 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   2.2 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   3.3 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   2.2 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.6 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.7 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.6 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   1.1 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   2.2 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   2.2 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   2.1 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   2.0 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   2.2 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.2 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.6 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.3 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.6 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   2.1 |
...
*** Split employee program into files
    CLOCK: [2018-02-07 Wed 13:52]
