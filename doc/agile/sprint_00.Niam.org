...
#+CAPTION: Clock summary at [2018-02-06 Tue 10:29]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *38:08* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 38:08   |       |      | 100.0 |
| Active                                                                      |         | 38:08 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   2.5 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   4.0 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.2 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.9 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   2.8 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.4 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.1 |
| COMPLETED Build main                                                        |         |       | 2:10 |   5.7 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.4 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   2.3 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   4.4 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   4.8 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.8 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.9 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   5.2 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.9 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.9 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   2.6 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.9 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   7.7 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   6.1 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.1 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   4.4 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   2.6 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   2.0 |
| COMPLETED Show detail of select player only                                 |         |       | 0:29 |   1.3 |
| COMPLETED Discuss task                                                      |         |       | 0:33 |   1.4 |
| COMPLETED Add the rest of the players                                       |         |       | 0:39 |   1.7 |
| COMPLETED Testing program                                                   |         |       | 1:00 |   2.6 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   2.6 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   3.9 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   2.6 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   2.0 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   2.0 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   2.0 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   1.3 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   2.6 |
