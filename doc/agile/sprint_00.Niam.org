...
#+CAPTION: Clock summary at [2018-02-12 Mon 14:20]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 62:39   |       |      | 100.0 |
| Active                                                                      |         | 62:39 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   1.5 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   2.4 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   0.7 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.6 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   1.7 |
...
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.7 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   2.9 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.5 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.6 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.2 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.4 |
...
| COMPLETED Research classes                                                  |         |       | 2:56 |   4.7 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   3.7 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.7 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.7 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.6 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.2 |
...
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   1.8 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.6 |
| COMPLETED Help PG split files                                               |         |       | 0:28 |   0.7 |
| COMPLETED Class constructor and multiple files Video                        |         |       | 0:54 |   1.4 |
...
| COMPLETED Discuss tasks                                                     |         |       | 0:30 |   0.8 |
| COMPLETED Review changes                                                    |         |       | 1:06 |   1.8 |
