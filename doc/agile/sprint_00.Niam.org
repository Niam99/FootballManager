...
#+CAPTION: Clock summary at [2018-02-08 Thu 10:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *49:49* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 49:49   |       |      | 100.0 |
| Active                                                                      |         | 49:49 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   1.9 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   3.1 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   0.9 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.7 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   2.2 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.1 |
| COMPLETED Create main                                                       |         |       | 0:26 |   0.9 |
| COMPLETED Build main                                                        |         |       | 2:10 |   4.3 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.0 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.7 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.4 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.6 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.6 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.7 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   4.0 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.0 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.7 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   2.0 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.2 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   5.9 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   4.7 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.9 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.4 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   2.0 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.5 |
| COMPLETED Show detail of select player only                                 |         |       | 0:29 |   1.0 |
| COMPLETED Discuss task                                                      |         |       | 0:33 |   1.1 |
| COMPLETED Add the rest of the players                                       |         |       | 0:39 |   1.3 |
| COMPLETED Testing program                                                   |         |       | 1:00 |   2.0 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   2.0 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   3.0 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   2.0 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.5 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.5 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.5 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   1.0 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   2.0 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   2.0 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.9 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.8 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   2.0 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.1 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.5 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.2 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.4 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.9 |
| COMPLETED Split employee program up                                         |         |       | 1:14 |   2.5 |
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   0.9 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   2.1 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.8 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   2.3 |
