...
#+CAPTION: Clock summary at [2018-02-12 Mon 11:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *61:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 61:03   |       |      | 100.0 |
| Active                                                                      |         | 61:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   1.6 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   2.5 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   0.8 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.6 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   1.8 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   0.9 |
| COMPLETED Create main                                                       |         |       | 0:26 |   0.7 |
| COMPLETED Build main                                                        |         |       | 2:10 |   3.5 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.8 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.4 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.8 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.0 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.5 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.6 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.3 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.5 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.5 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.6 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   1.8 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   4.8 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   3.8 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.7 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.8 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.6 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.3 |
| COMPLETED Show detail of select player only                                 |         |       | 0:29 |   0.8 |
| COMPLETED Discuss task                                                      |         |       | 0:33 |   0.9 |
| COMPLETED Add the rest of the players                                       |         |       | 0:39 |   1.1 |
| COMPLETED Testing program                                                   |         |       | 1:00 |   1.6 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   1.6 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   2.5 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   1.6 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.2 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.3 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.2 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   0.8 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   1.6 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   1.7 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.5 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.5 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   1.6 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   0.9 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.2 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.2 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   1.9 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.5 |
| COMPLETED Split employee program up                                         |         |       | 1:14 |   2.0 |
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   0.8 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   1.7 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.6 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   1.9 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.6 |
| COMPLETED Help PG split files                                               |         |       | 0:28 |   0.8 |
| COMPLETED Class constructor and multiple files Video                        |         |       | 0:54 |   1.5 |
| COMPLETED Make another object                                               |         |       | 0:23 |   0.6 |
| COMPLETED Allow user to add employee/object                                 |         |       | 0:56 |   1.5 |
| COMPLETED Discuss tasks                                                     |         |       | 0:30 |   0.8 |
| COMPLETED Research tasks                                                    |         |       | 0:36 |   1.0 |
| COMPLETED Watch classes video                                               |         |       | 0:53 |   1.4 |
| COMPLETED Employee IO program                                               |         |       | 1:03 |   1.7 |
| COMPLETED Test Employee IO program                                          |         |       | 1:00 |   1.6 |
| COMPLETED Review player class in FM                                         |         |       | 0:38 |   1.0 |
| COMPLETED Discuss tasks                                                     |         |       | 0:13 |   0.4 |
| COMPLETED Discuss code                                                      |         |       | 0:40 |   1.1 |
| COMPLETED Read about Object oriented programming                            |         |       | 0:42 |   1.1 |
| COMPLETED Start league class                                                |         |       | 0:48 |   1.3 |
| COMPLETED Add league class to main                                          |         |       | 0:30 |   0.8 |
