...
#+CAPTION: Clock summary at [2018-01-31 Wed 16:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:03* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:03   |       |      | 100.0 |
| Active                                                                      |         | 19:03 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   5.1 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   8.0 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   2.4 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   1.8 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   5.7 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   2.9 |
| COMPLETED Create main                                                       |         |       | 0:26 |   2.3 |
| COMPLETED Build main                                                        |         |       | 2:10 |  11.4 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   2.7 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   4.5 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   8.8 |
| POSTPONED Research classes                                                  |         |       | 1:49 |   9.5 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.7 |
| COMPLETED Create players class                                              |         |       | 0:21 |   1.8 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |  10.5 |
| STARTED create setup function in player class                               |         |       | 1:30 |   7.9 |
| STARTED create display function in player class                             |         |       | 0:20 |   1.7 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   5.2 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   5.9 |
