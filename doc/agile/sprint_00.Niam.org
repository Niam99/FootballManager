...
#+CAPTION: Clock summary at [2018-02-19 Mon 11:47]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *87:31* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 87:31   |       |      | 100.0 |
| Active                                                                      |         | 87:31 |      | 100.0 |
...
| COMPLETED Practice branches                                                 |         |       | 1:05 |   1.2 |
...
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   1.9 |
...
| STARTED create setup function in player class                               |         |       | 1:30 |   1.7 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.4 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.1 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   1.3 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   3.4 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   2.6 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.5 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   1.9 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.1 |
...
| COMPLETED Testing program                                                   |         |       | 1:00 |   1.1 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   1.1 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   1.7 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   1.1 |
...
| COMPLETED Review pointers                                                   |         |       | 1:00 |   1.1 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   1.2 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.1 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.0 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   1.1 |
...
| COMPLETED Testing employee program                                          |         |       | 1:04 |   1.2 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.4 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   1.3 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.1 |
| COMPLETED Help PG split files                                               |         |       | 0:28 |   0.5 |
| COMPLETED Class constructor and multiple files Video                        |         |       | 0:54 |   1.0 |
...
| COMPLETED Test Employee IO program                                          |         |       | 1:00 |   1.1 |
...
| COMPLETED Start game class                                                  |         |       | 1:00 |   1.1 |
...
| COMPLETED Build and test MC game                                            |         |       | 1:00 |   1.1 |
...
| COMPLETED Check through program for errors                                  |         |       | 1:00 |   1.1 |
| COMPLETED Practice IO                                                       |         |       | 1:00 |   1.1 |
...
| COMPLETED Make practice files                                               |         |       | 1:30 |   1.7 |
| COMPLETED Make player class                                                 |         |       | 1:00 |   1.1 |
| COMPLETED Implement player class                                            |         |       | 0:56 |   1.1 |
| COMPLETED Discuss solution for view players based on team                   |         |       | 1:00 |   1.1 |
| COMPLETED Try to implement a solution                                       |         |       | 1:52 |   2.1 |
| COMPLETED Review program                                                    |         |       | 1:00 |   1.1 |
| COMPLETED Discuss tasks/changes                                             |         |       | 0:30 |   0.6 |
