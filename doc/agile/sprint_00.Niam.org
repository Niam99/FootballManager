...
#+CAPTION: Clock summary at [2018-02-15 Thu 16:02]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *80:29* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 80:29   |       |      | 100.0 |
| Active                                                                      |         | 80:29 |      | 100.0 |
...
| COMPLETED Build main                                                        |         |       | 2:10 |   2.7 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.6 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.1 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.1 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   2.3 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.4 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.4 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   2.5 |
| STARTED create setup function in player class                               |         |       | 1:30 |   1.9 |
...
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   2.9 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.5 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.1 |
...
| COMPLETED Pointers - research                                               |         |       | 1:30 |   1.9 |
...
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   1.3 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.2 |
...
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   1.5 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.2 |
...
| COMPLETED Allow user to add employee/object                                 |         |       | 0:56 |   1.2 |
...
| COMPLETED Review sample program                                             |         |       | 2:00 |   2.5 |
| COMPLETED Fix league class                                                  |         |       | 0:51 |   1.1 |
...
| COMPLETED Add league function to main                                       |         |       | 0:56 |   1.2 |
| COMPLETED Fix travis error                                                  |         |       | 0:25 |   0.5 |
| COMPLETED Fix travis error                                                  |         |       | 0:15 |   0.3 |
| COMPLETED Make practice files                                               |         |       | 1:30 |   1.9 |
