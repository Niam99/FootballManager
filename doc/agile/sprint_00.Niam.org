...
#+CAPTION: Clock summary at [2018-02-06 Tue 16:45]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *42:33* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 42:33   |       |      | 100.0 |
| Active                                                                      |         | 42:33 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   2.3 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   3.6 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.1 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   0.8 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   2.5 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   1.3 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.0 |
| COMPLETED Build main                                                        |         |       | 2:10 |   5.1 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.2 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   2.0 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   4.0 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   4.3 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.7 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.8 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   4.7 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.5 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.8 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   2.4 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.6 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   6.9 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   5.4 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.0 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   4.0 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   2.4 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.8 |
| COMPLETED Show detail of select player only                                 |         |       | 0:29 |   1.1 |
| COMPLETED Discuss task                                                      |         |       | 0:33 |   1.3 |
| COMPLETED Add the rest of the players                                       |         |       | 0:39 |   1.5 |
| COMPLETED Testing program                                                   |         |       | 1:00 |   2.4 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   2.4 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   3.5 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   2.4 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.8 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.8 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.8 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   1.2 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   2.4 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   2.4 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   2.2 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   2.1 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   2.4 |
