...
#+CAPTION: Clock summary at [2018-02-02 Fri 10:41]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *26:25* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 26:25   |       |      | 100.0 |
| Active                                                                      |         | 26:25 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   3.7 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   5.8 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.8 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   1.3 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   4.1 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   2.1 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.6 |
| COMPLETED Build main                                                        |         |       | 2:10 |   8.2 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   2.0 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   3.3 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   6.4 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   6.9 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.2 |
| COMPLETED Create players class                                              |         |       | 0:21 |   1.3 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   7.6 |
| STARTED create setup function in player class                               |         |       | 1:30 |   5.7 |
| STARTED create display function in player class                             |         |       | 0:20 |   1.3 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   3.8 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   4.2 |
| COMPLETED Research classes                                                  |         |       | 2:56 |  11.1 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   8.8 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.6 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   6.4 |
