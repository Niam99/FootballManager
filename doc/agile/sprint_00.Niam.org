...
#+CAPTION: Clock summary at [2018-02-22 Thu 16:01]
| <75>                                                                        |          |        |      |       |
| Headline                                                                    | Time     |        |      |     % |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| *Total time*                                                                | *108:37* |        |      | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| Stories                                                                     | 108:37   |        |      | 100.0 |
| Active                                                                      |          | 108:37 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |          |        | 0:58 |   0.9 |
| COMPLETED Add gpg                                                           |          |        | 1:32 |   1.4 |
| COMPLETED Test commits to branch                                            |          |        | 0:28 |   0.4 |
| COMPLETED Test verification                                                 |          |        | 0:21 |   0.3 |
| COMPLETED Practice branches                                                 |          |        | 1:05 |   1.0 |
| COMPLETED Fix travis                                                        |          |        | 0:33 |   0.5 |
| COMPLETED Create main                                                       |          |        | 0:26 |   0.4 |
| COMPLETED Build main                                                        |          |        | 2:10 |   2.0 |
| COMPLETED Discuss task                                                      |          |        | 0:31 |   0.5 |
| COMPLETED Create a Menu class                                               |          |        | 0:52 |   0.8 |
| COMPLETED Fix menu class                                                    |          |        | 1:41 |   1.5 |
| COMPLETED Research classes                                                  |          |        | 1:49 |   1.7 |
| COMPLETED Add new option to list                                            |          |        | 0:19 |   0.3 |
| COMPLETED Create players class                                              |          |        | 0:21 |   0.3 |
| POSTPONED Fix player class                                                  |          |        | 2:00 |   1.8 |
| STARTED create setup function in player class                               |          |        | 1:30 |   1.4 |
| STARTED create display function in player class                             |          |        | 0:20 |   0.3 |
| COMPLETED Create vector for players                                         |          |        | 1:00 |   0.9 |
| COMPLETED Read through fixed player class                                   |          |        | 1:07 |   1.0 |
| COMPLETED Research classes                                                  |          |        | 2:56 |   2.7 |
| COMPLETED Dealing with conflicts in magit                                   |          |        | 2:19 |   2.1 |
| COMPLETED Practice implementing class with functions                        |          |        | 0:26 |   0.4 |
| COMPLETED Research classes                                                  |          |        | 1:41 |   1.5 |
| COMPLETED Add detail to players                                             |          |        | 1:00 |   0.9 |
| COMPLETED Add new player                                                    |          |        | 0:46 |   0.7 |
| COMPLETED Show detail of select player only                                 |          |        | 0:29 |   0.4 |
| COMPLETED Discuss task                                                      |          |        | 0:33 |   0.5 |
| COMPLETED Add the rest of the players                                       |          |        | 0:39 |   0.6 |
| COMPLETED Testing program                                                   |          |        | 1:00 |   0.9 |
| COMPLETED Learning about pointers- videos                                   |          |        | 1:00 |   0.9 |
| COMPLETED Pointers - research                                               |          |        | 1:30 |   1.4 |
| COMPLETED Pointers - tutorials                                              |          |        | 1:00 |   0.9 |
| COMPLETED Pointers - examples                                               |          |        | 0:45 |   0.7 |
| COMPLETED Pointers - program                                                |          |        | 0:46 |   0.7 |
| COMPLETED Testing program                                                   |          |        | 0:45 |   0.7 |
| COMPLETED Discussing program                                                |          |        | 0:30 |   0.5 |
| COMPLETED Review pointers                                                   |          |        | 1:00 |   0.9 |
| COMPLETED Research pointers to data structures                              |          |        | 1:01 |   0.9 |
| COMPLETED Pointers with array program                                       |          |        | 0:56 |   0.9 |
| COMPLETED Data structures reading                                           |          |        | 0:54 |   0.8 |
| COMPLETED Pointers and classes                                              |          |        | 1:00 |   0.9 |
| COMPLETED Pointers and classes program                                      |          |        | 0:34 |   0.5 |
| COMPLETED Review                                                            |          |        | 0:44 |   0.7 |
| COMPLETED Discussing tasks                                                  |          |        | 0:07 |   0.1 |
| COMPLETED Pointers practice                                                 |          |        | 1:11 |   1.1 |
| COMPLETED Pointers, classes, - employee program                             |          |        | 0:56 |   0.9 |
| COMPLETED Split employee program up                                         |          |        | 1:14 |   1.1 |
| COMPLETED Looking at PGs program                                            |          |        | 0:28 |   0.4 |
| COMPLETED Testing employee program                                          |          |        | 1:04 |   1.0 |
| COMPLETED comparing w/ PG                                                   |          |        | 0:23 |   0.4 |
| COMPLETED Add another function to employee program                          |          |        | 1:09 |   1.1 |
| COMPLETED Research class constructors                                       |          |        | 1:00 |   0.9 |
| COMPLETED Help PG split files                                               |          |        | 0:28 |   0.4 |
| COMPLETED Class constructor and multiple files Video                        |          |        | 0:54 |   0.8 |
| COMPLETED Make another object                                               |          |        | 0:23 |   0.4 |
| COMPLETED Allow user to add employee/object                                 |          |        | 0:56 |   0.9 |
| COMPLETED Discuss tasks                                                     |          |        | 0:30 |   0.5 |
| COMPLETED Research tasks                                                    |          |        | 0:36 |   0.6 |
| COMPLETED Watch classes video                                               |          |        | 0:53 |   0.8 |
| COMPLETED Employee IO program                                               |          |        | 1:03 |   1.0 |
| COMPLETED Test Employee IO program                                          |          |        | 1:00 |   0.9 |
| COMPLETED Review player class in FM                                         |          |        | 0:38 |   0.6 |
| COMPLETED Discuss tasks                                                     |          |        | 0:13 |   0.2 |
| COMPLETED Discuss code                                                      |          |        | 0:40 |   0.6 |
| COMPLETED Read about Object oriented programming                            |          |        | 0:42 |   0.6 |
| COMPLETED Start league class                                                |          |        | 0:48 |   0.7 |
| COMPLETED Add league class to main                                          |          |        | 0:30 |   0.5 |
| COMPLETED Discuss tasks                                                     |          |        | 0:30 |   0.5 |
| COMPLETED Review changes                                                    |          |        | 1:06 |   1.0 |
| COMPLETED Add more team data to league                                      |          |        | 0:37 |   0.6 |
| COMPLETED Testing                                                           |          |        | 1:02 |   1.0 |
| COMPLETED Review code/research tasks                                        |          |        | 1:01 |   0.9 |
| COMPLETED Start game class                                                  |          |        | 1:00 |   0.9 |
| COMPLETED Discuss game and look through code                                |          |        | 1:19 |   1.2 |
| COMPLETED Add game to main                                                  |          |        | 0:23 |   0.4 |
| COMPLETED Read MC sample game                                               |          |        | 0:25 |   0.4 |
| COMPLETED Build and test MC game                                            |          |        | 1:00 |   0.9 |
| COMPLETED Research parts of code                                            |          |        | 0:33 |   0.5 |
| COMPLETED Research IO/Myfile                                                |          |        | 0:40 |   0.6 |
| COMPLETED Review sample program                                             |          |        | 2:00 |   1.8 |
| COMPLETED Fix league class                                                  |          |        | 0:51 |   0.8 |
| COMPLETED Check through program for errors                                  |          |        | 1:00 |   0.9 |
| COMPLETED Practice IO                                                       |          |        | 1:00 |   0.9 |
| COMPLETED Fix league                                                        |          |        | 0:53 |   0.8 |
| COMPLETED Look through sample main                                          |          |        | 0:45 |   0.7 |
| COMPLETED Review changes                                                    |          |        | 0:15 |   0.2 |
| COMPLETED Add league function to main                                       |          |        | 0:56 |   0.9 |
| COMPLETED Fix travis error                                                  |          |        | 0:25 |   0.4 |
| COMPLETED Fix travis error                                                  |          |        | 0:15 |   0.2 |
| COMPLETED Make practice files                                               |          |        | 1:30 |   1.4 |
| COMPLETED Make player class                                                 |          |        | 1:00 |   0.9 |
| COMPLETED Implement player class                                            |          |        | 0:56 |   0.9 |
| COMPLETED Discuss solution for view players based on team                   |          |        | 1:00 |   0.9 |
| COMPLETED Try to implement a solution                                       |          |        | 1:52 |   1.7 |
| COMPLETED Review program                                                    |          |        | 1:00 |   0.9 |
| COMPLETED Discuss tasks/changes                                             |          |        | 0:30 |   0.5 |
| COMPLETED Add team data files                                               |          |        | 0:44 |   0.7 |
| COMPLETED Discuss solution to league table                                  |          |        | 0:45 |   0.7 |
| COMPLETED Research I/O for files                                            |          |        | 0:45 |   0.7 |
| COMPLETED Test current program                                              |          |        | 0:40 |   0.6 |
| COMPLETED Watch videos about read/write custom files                        |          |        | 0:59 |   0.9 |
| COMPLETED Write program to practice reading custom files                    |          |        | 0:40 |   0.6 |
| COMPLETED Watch read/write videos                                           |          |        | 1:46 |   1.6 |
| COMPLETED Add variables to read/write program                               |          |        | 1:18 |   1.2 |
| POSTPONED Add class to read/write program                                   |          |        | 3:32 |   3.3 |
| COMPLETED Research about istream/fstream                                    |          |        | 1:02 |   1.0 |
| COMPLETED Review table.cpp                                                  |          |        | 0:30 |   0.5 |
| COMPLETED Discuss tasks/data model                                          |          |        | 0:30 |   0.5 |
| COMPLETED Review sample program                                             |          |        | 1:10 |   1.1 |
| COMPLETED Watch OOP videos                                                  |          |        | 1:34 |   1.4 |
| COMPLETED Review OOP videos                                                 |          |        | 0:55 |   0.8 |
| COMPLETED Read OOP tutorial                                                 |          |        | 1:14 |   1.1 |
| COMPLETED Read std::sort                                                    |          |        | 0:37 |   0.6 |
| COMPLETED Read std::find                                                    |          |        | 0:57 |   0.9 |
| COMPLETED Discuss tasks                                                     |          |        | 0:55 |   0.8 |
| COMPLETED Create player class                                               |          |        | 0:27 |   0.4 |
| COMPLETED Fix data model                                                    |          |        | 0:50 |   0.8 |
