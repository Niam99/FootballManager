...
#+CAPTION: Clock summary at [2018-02-07 Wed 11:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 44:35   |       |      | 100.0 |
| Active                                                                      |         | 44:35 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   2.2 |
...
| COMPLETED Build main                                                        |         |       | 2:10 |   4.9 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.2 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.9 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.8 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   4.1 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.7 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.8 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   4.5 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.4 |
...
| COMPLETED Research classes                                                  |         |       | 2:56 |   6.6 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   5.2 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.0 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.8 |
...
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.3 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.6 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.3 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.7 |
