...
#+CAPTION: Clock summary at [2018-02-15 Thu 13:55]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *78:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 78:44   |       |      | 100.0 |
| Active                                                                      |         | 78:44 |      | 100.0 |
...
| COMPLETED Practice branches                                                 |         |       | 1:05 |   1.4 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   0.7 |
| COMPLETED Create main                                                       |         |       | 0:26 |   0.6 |
| COMPLETED Build main                                                        |         |       | 2:10 |   2.8 |
...
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.3 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   1.4 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   3.7 |
...
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.3 |
...
| COMPLETED Testing program                                                   |         |       | 1:00 |   1.3 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   1.3 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   1.9 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   1.3 |
...
| COMPLETED Review pointers                                                   |         |       | 1:00 |   1.3 |
...
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   1.3 |
...
| COMPLETED Split employee program up                                         |         |       | 1:14 |   1.6 |
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   0.6 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   1.4 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.5 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   1.5 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.3 |
...
| COMPLETED Test Employee IO program                                          |         |       | 1:00 |   1.3 |
...
| COMPLETED Start game class                                                  |         |       | 1:00 |   1.3 |
| COMPLETED Discuss game and look through code                                |         |       | 1:19 |   1.7 |
| COMPLETED Add game to main                                                  |         |       | 0:23 |   0.5 |
| COMPLETED Read MC sample game                                               |         |       | 0:25 |   0.5 |
| COMPLETED Build and test MC game                                            |         |       | 1:00 |   1.3 |
...
| COMPLETED Check through program for errors                                  |         |       | 1:00 |   1.3 |
| COMPLETED Practice IO                                                       |         |       | 1:00 |   1.3 |
| COMPLETED Fix league                                                        |         |       | 0:53 |   1.1 |
| COMPLETED Look through sample main                                          |         |       | 0:45 |   1.0 |
