...
#+CAPTION: Clock summary at [2018-02-28 Wed 16:46]
| <75>                                                                        |          |        |      |       |
| Headline                                                                    | Time     |        |      |     % |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| *Total time*                                                                | *134:07* |        |      | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| Stories                                                                     | 134:07   |        |      | 100.0 |
| Active                                                                      |          | 134:07 |      | 100.0 |
...
| POSTPONED Fix player class                                                  |          |        | 2:00 |   1.5 |
| STARTED create setup function in player class                               |          |        | 1:30 |   1.1 |
...
| COMPLETED Research classes                                                  |          |        | 2:56 |   2.2 |
| COMPLETED Dealing with conflicts in magit                                   |          |        | 2:19 |   1.7 |
...
| COMPLETED Pointers - research                                               |          |        | 1:30 |   1.1 |
...
| COMPLETED Review sample program                                             |          |        | 2:00 |   1.5 |
...
| COMPLETED Make practice files                                               |          |        | 1:30 |   1.1 |
...
| COMPLETED Try to implement a solution                                       |          |        | 1:52 |   1.4 |
...
| COMPLETED Watch read/write videos                                           |          |        | 1:46 |   1.3 |
| COMPLETED Add variables to read/write program                               |          |        | 1:18 |   1.0 |
| POSTPONED Add class to read/write program                                   |          |        | 3:32 |   2.6 |
...
| COMPLETED Attempt to fix build                                              |          |        | 1:37 |   1.2 |
| COMPLETED Watch istream/fsteeam/getline video                               |          |        | 1:30 |   1.1 |
...
| COMPLETED Review program                                                    |          |        | 1:30 |   1.1 |
| COMPLETED watch oop playlist                                                |          |        | 1:00 |   0.7 |
| COMPLETED Discuss tasks                                                     |          |        | 1:51 |   1.4 |
| COMPLETED Review PG changes                                                 |          |        | 0:15 |   0.2 |
| COMPLETED Practice using variables from file                                |          |        | 4:25 |   3.3 |
| COMPLETED Watch OOP video                                                   |          |        | 0:31 |   0.4 |
| POSTPONED Display players of 1 team                                         |          |        | 4:00 |   3.0 |
| COMPLETED Discuss tasks                                                     |          |        | 0:21 |   0.3 |
| COMPLETED Watch oop video                                                   |          |        | 0:53 |   0.7 |
| COMPLETED Research objects in memory                                        |          |        | 3:57 |   2.9 |
...
*** Add team code to main project
    CLOCK: [2018-03-01 Thu 14:13]
