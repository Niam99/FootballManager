...
#+CAPTION: Clock summary at [2018-02-09 Fri 16:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Build main                                                        |         |       | 2:10 |   3.7 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   0.9 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.5 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   2.9 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.1 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.5 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.6 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   3.4 |
| STARTED create setup function in player class                               |         |       | 1:30 |   2.5 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.6 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   1.7 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   1.9 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   5.0 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   3.9 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.7 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   2.9 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   1.7 |
...
| COMPLETED Testing program                                                   |         |       | 1:00 |   1.7 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   1.7 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   2.5 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   1.7 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.3 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.3 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.3 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   0.8 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   1.7 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   1.7 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.6 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.5 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   1.7 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.0 |
| COMPLETED Review                                                            |         |       | 0:44 |   1.2 |
| COMPLETED Discussing tasks                                                  |         |       | 0:07 |   0.2 |
| COMPLETED Pointers practice                                                 |         |       | 1:11 |   2.0 |
| COMPLETED Pointers, classes, - employee program                             |         |       | 0:56 |   1.6 |
| COMPLETED Split employee program up                                         |         |       | 1:14 |   2.1 |
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   0.8 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   1.8 |
| COMPLETED comparing w/ PG                                                   |         |       | 0:23 |   0.6 |
| COMPLETED Add another function to employee program                          |         |       | 1:09 |   1.9 |
| COMPLETED Research class constructors                                       |         |       | 1:00 |   1.7 |
...
| COMPLETED Allow user to add employee/object                                 |         |       | 0:56 |   1.6 |
| COMPLETED Discuss tasks                                                     |         |       | 0:30 |   0.8 |
| COMPLETED Research tasks                                                    |         |       | 0:36 |   1.0 |
| COMPLETED Watch classes video                                               |         |       | 0:53 |   1.5 |
| COMPLETED Employee IO program                                               |         |       | 1:03 |   1.8 |
| COMPLETED Test Employee IO program                                          |         |       | 1:00 |   1.7 |
| COMPLETED Review player class in FM                                         |         |       | 0:38 |   1.1 |
