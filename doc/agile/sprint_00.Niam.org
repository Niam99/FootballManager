...
#+CAPTION: Clock summary at [2018-01-31 Wed 14:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:56   |       |      | 100.0 |
| Active                                                                      |         | 16:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   5.7 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   9.1 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   2.8 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   2.1 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   6.4 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   3.2 |
| COMPLETED Create main                                                       |         |       | 0:26 |   2.6 |
| COMPLETED Build main                                                        |         |       | 2:10 |  12.8 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   3.1 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   5.1 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   9.9 |
| POSTPONED Research classes                                                  |         |       | 1:49 |  10.7 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.9 |
| COMPLETED Create players class                                              |         |       | 0:21 |   2.1 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |  11.8 |
| STARTED create setup function in player class                               |         |       | 1:30 |   8.9 |
| STARTED create display function in player class                             |         |       | 0:20 |   2.0 |
