...
#+CAPTION: Clock summary at [2018-02-21 Wed 16:50]
| <75>                                                                        |          |        |      |       |
| Headline                                                                    | Time     |        |      |     % |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| *Total time*                                                                | *102:42* |        |      | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+------+-------|
| Stories                                                                     | 102:42   |        |      | 100.0 |
| Active                                                                      |          | 102:42 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |          |        | 0:58 |   0.9 |
| COMPLETED Add gpg                                                           |          |        | 1:32 |   1.5 |
...
| COMPLETED Pointers - research                                               |          |        | 1:30 |   1.5 |
...
| COMPLETED Research pointers to data structures                              |          |        | 1:01 |   1.0 |
...
| COMPLETED Split employee program up                                         |          |        | 1:14 |   1.2 |
...
| COMPLETED Review code/research tasks                                        |          |        | 1:01 |   1.0 |
| COMPLETED Start game class                                                  |          |        | 1:00 |   1.0 |
| COMPLETED Discuss game and look through code                                |          |        | 1:19 |   1.3 |
...
| COMPLETED Make practice files                                               |          |        | 1:30 |   1.5 |
...
| COMPLETED Try to implement a solution                                       |          |        | 1:52 |   1.8 |
...
| COMPLETED Watch read/write videos                                           |          |        | 1:46 |   1.7 |
| COMPLETED Add variables to read/write program                               |          |        | 1:18 |   1.3 |
| POSTPONED Add class to read/write program                                   |          |        | 3:32 |   3.4 |
