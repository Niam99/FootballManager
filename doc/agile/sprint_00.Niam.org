...
#+CAPTION: Clock summary at [2018-02-01 Thu 16:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *24:44* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 24:44   |       |      | 100.0 |
| Active                                                                      |         | 24:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   3.9 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   6.2 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.9 |
| COMPLETED Test verification                                                 |         |       | 0:21 |   1.4 |
| COMPLETED Practice branches                                                 |         |       | 1:05 |   4.4 |
| COMPLETED Fix travis                                                        |         |       | 0:33 |   2.2 |
| COMPLETED Create main                                                       |         |       | 0:26 |   1.8 |
| COMPLETED Build main                                                        |         |       | 2:10 |   8.8 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   2.1 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   3.5 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   6.8 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   7.3 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   1.3 |
| COMPLETED Create players class                                              |         |       | 0:21 |   1.4 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   8.1 |
| STARTED create setup function in player class                               |         |       | 1:30 |   6.1 |
| STARTED create display function in player class                             |         |       | 0:20 |   1.3 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   4.0 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   4.5 |
| Research classes                                                            |         |       | 2:56 |  11.9 |
| Dealing with conflicts in magit                                             |         |       | 2:19 |   9.4 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   1.8 |
...
*** Dealing with conflicts in magit
