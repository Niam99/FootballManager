...
| COMPLETED Research classes                                                  |          |        | 2:56 |   2.5 |
| COMPLETED Dealing with conflicts in magit                                   |          |        | 2:19 |   1.9 |
| COMPLETED Practice implementing class with functions                        |          |        | 0:26 |   0.4 |
| COMPLETED Research classes                                                  |          |        | 1:41 |   1.4 |
...
| COMPLETED Pointers - research                                               |          |        | 1:30 |   1.3 |
...
| COMPLETED Pointers with array program                                       |          |        | 0:56 |   0.8 |
...
| COMPLETED Pointers practice                                                 |          |        | 1:11 |   1.0 |
| COMPLETED Pointers, classes, - employee program                             |          |        | 0:56 |   0.8 |
| COMPLETED Split employee program up                                         |          |        | 1:14 |   1.0 |
| COMPLETED Looking at PGs program                                            |          |        | 0:28 |   0.4 |
| COMPLETED Testing employee program                                          |          |        | 1:04 |   0.9 |
| COMPLETED comparing w/ PG                                                   |          |        | 0:23 |   0.3 |
| COMPLETED Add another function to employee program                          |          |        | 1:09 |   1.0 |
...
| COMPLETED Review sample program                                             |          |        | 2:00 |   1.7 |
...
| COMPLETED Watch read/write videos                                           |          |        | 1:46 |   1.5 |
| COMPLETED Add variables to read/write program                               |          |        | 1:18 |   1.1 |
| POSTPONED Add class to read/write program                                   |          |        | 3:32 |   3.0 |
| COMPLETED Research about istream/fstream                                    |          |        | 1:02 |   0.9 |
| COMPLETED Review table.cpp                                                  |          |        | 0:30 |   0.4 |
| COMPLETED Discuss tasks/data model                                          |          |        | 0:30 |   0.4 |
| COMPLETED Review sample program                                             |          |        | 1:10 |   1.0 |
| COMPLETED Watch OOP videos                                                  |          |        | 1:34 |   1.3 |
| COMPLETED Review OOP videos                                                 |          |        | 0:55 |   0.8 |
| COMPLETED Read OOP tutorial                                                 |          |        | 1:14 |   1.0 |
| COMPLETED Read std::sort                                                    |          |        | 0:37 |   0.5 |
| COMPLETED Read std::find                                                    |          |        | 0:57 |   0.8 |
...
| COMPLETED Attempt to fix build                                              |          |        | 1:37 |   1.4 |
| COMPLETED Watch istream/fsteeam/getline video                               |          |        | 1:30 |   1.3 |
| COMPLETED Review code                                                       |          |        | 0:30 |   0.4 |
| COMPLETED watch getline video 2                                             |          |        | 1:00 |   0.8 |
| COMPLETED Watch OOP video                                                   |          |        | 1:00 |   0.8 |
| COMPLETED Review diagram                                                    |          |        | 0:40 |   0.6 |
| COMPLETED Review program                                                    |          |        | 1:30 |   1.3 |
| COMPLETED watch oop playlist                                                |          |        | 1:00 |   0.8 |
| COMPLETED Discuss tasks                                                     |          |        | 1:00 |   0.8 |
...
*** POSTPONED Practice using variables from file
    CLOSED: [2018-02-26 Mon 16:44]
