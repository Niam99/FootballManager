...
#+CAPTION: Clock summary at [2018-02-07 Wed 16:52]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *48:40* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 48:40   |       |      | 100.0 |
| Active                                                                      |         | 48:40 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:58 |   2.0 |
| COMPLETED Add gpg                                                           |         |       | 1:32 |   3.2 |
| COMPLETED Test commits to branch                                            |         |       | 0:28 |   1.0 |
...
| COMPLETED Build main                                                        |         |       | 2:10 |   4.5 |
| COMPLETED Discuss task                                                      |         |       | 0:31 |   1.1 |
| COMPLETED Create a Menu class                                               |         |       | 0:52 |   1.8 |
| COMPLETED Fix menu class                                                    |         |       | 1:41 |   3.5 |
| COMPLETED Research classes                                                  |         |       | 1:49 |   3.7 |
| COMPLETED Add new option to list                                            |         |       | 0:19 |   0.7 |
| COMPLETED Create players class                                              |         |       | 0:21 |   0.7 |
| POSTPONED Fix player class                                                  |         |       | 2:00 |   4.1 |
| STARTED create setup function in player class                               |         |       | 1:30 |   3.1 |
| STARTED create display function in player class                             |         |       | 0:20 |   0.7 |
| COMPLETED Create vector for players                                         |         |       | 1:00 |   2.1 |
| COMPLETED Read through fixed player class                                   |         |       | 1:07 |   2.3 |
| COMPLETED Research classes                                                  |         |       | 2:56 |   6.0 |
| COMPLETED Dealing with conflicts in magit                                   |         |       | 2:19 |   4.8 |
| COMPLETED Practice implementing class with functions                        |         |       | 0:26 |   0.9 |
| COMPLETED Research classes                                                  |         |       | 1:41 |   3.5 |
| COMPLETED Add detail to players                                             |         |       | 1:00 |   2.1 |
| COMPLETED Add new player                                                    |         |       | 0:46 |   1.6 |
...
| COMPLETED Testing program                                                   |         |       | 1:00 |   2.1 |
| COMPLETED Learning about pointers- videos                                   |         |       | 1:00 |   2.1 |
| COMPLETED Pointers - research                                               |         |       | 1:30 |   3.1 |
| COMPLETED Pointers - tutorials                                              |         |       | 1:00 |   2.1 |
| COMPLETED Pointers - examples                                               |         |       | 0:45 |   1.5 |
| COMPLETED Pointers - program                                                |         |       | 0:46 |   1.6 |
| COMPLETED Testing program                                                   |         |       | 0:45 |   1.5 |
| COMPLETED Discussing program                                                |         |       | 0:30 |   1.0 |
| COMPLETED Review pointers                                                   |         |       | 1:00 |   2.1 |
| COMPLETED Research pointers to data structures                              |         |       | 1:01 |   2.1 |
| COMPLETED Pointers with array program                                       |         |       | 0:56 |   1.9 |
| COMPLETED Data structures reading                                           |         |       | 0:54 |   1.8 |
| COMPLETED Pointers and classes                                              |         |       | 1:00 |   2.1 |
| COMPLETED Pointers and classes program                                      |         |       | 0:34 |   1.2 |
...
| COMPLETED Looking at PGs program                                            |         |       | 0:28 |   1.0 |
| COMPLETED Testing employee program                                          |         |       | 1:04 |   2.2 |
