...
#+CAPTION: Clock summary at [2018-02-26 Mon 13:08]
| <75>                                                                        |          |        |       |       |
| Headline                                                                    | Time     |        |       |     % |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| *Total time*                                                                | *111:42* |        |       | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| Stories                                                                     | 111:42   |        |       | 100.0 |
| Active                                                                      |          | 111:42 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |          |        |  9:03 |   8.1 |
| COMPLETED Understanding Some Essentials of MaGit                            |          |        |  5:28 |   4.9 |
...
| STARTED Use Menu Classes for Teams menu                                     |          |        |  5:14 |   4.7 |
| Magit and attempting to fix first conflict                                  |          |        |  0:27 |   0.4 |
| Practice Classes                                                            |          |        |  5:36 |   5.0 |
| COMPLETED Having trouble with Magit                                         |          |        |  3:15 |   2.9 |
| Discussing the task at hand                                                 |          |        | 15:51 |  14.2 |
...
| STARTED Attempt to use pointer, array and classes                           |          |        |  6:23 |   5.7 |
| Attempt to read and write in Employee                                       |          |        |  1:04 |   1.0 |
| STARTED Get Team Menu working                                               |          |        |  6:14 |   5.6 |
| Evaluate and learn from MC's work                                           |          |        |  1:03 |   0.9 |
| COMPLETED Fix the build                                                     |          |        |  0:30 |   0.4 |
| Use MC's work to strengthen mine                                            |          |        |  6:10 |   5.5 |
| Print complete list of teams                                                |          |        |  2:33 |   2.3 |
| Print players in team                                                       |          |        |  3:14 |   2.9 |
...
| Attempt to create table using team data files                               |          |        |  5:46 |   5.2 |
...
| Fix football game diagram                                                   |          |        |  0:37 |   0.6 |
