...
#+CAPTION: Clock summary at [2018-02-07 Wed 17:05]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 44:14   |       |      | 100.0 |
| Active                                                                      |         | 44:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:30 |  10.2 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |  12.4 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   2.2 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.6 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   5.0 |
| COMPLETED Read more on Classes                                              |         |       | 0:36 |   1.4 |
| COMPLETED Review and study MC's work                                        |         |       | 1:12 |   2.7 |
| CANCELLED Try an make changes using MC's work                               |         |       | 0:20 |   0.8 |
| COMPLETED Read about vectors to help add teams                              |         |       | 0:51 |   1.9 |
| STARTED Use Menu Classes for Teams menu                                     |         |       | 3:27 |   7.8 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   1.0 |
| Practice Classes                                                            |         |       | 5:36 |  12.7 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   7.3 |
| Discussing the task at hand                                                 |         |       | 3:24 |   7.7 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.5 |
| Searching for research material                                             |         |       | 0:41 |   1.5 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   3.7 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   4.1 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.8 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   3.9 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:16 |   2.9 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   1.5 |
| Review yesterdays work                                                      |         |       | 0:38 |   1.4 |
| Attempt to use pointer, array and classes                                   |         |       | 2:16 |   5.1 |
