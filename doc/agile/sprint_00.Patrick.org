...
#+CAPTION: Clock summary at [2018-03-05 Mon 18:31]
| <75>                                                                        |          |        |       |       |
| Headline                                                                    | Time     |        |       |     % |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
...
| STARTED Use Menu Classes for Teams menu                                     |          |        |  5:14 |   3.9 |
| Magit and attempting to fix first conflict                                  |          |        |  0:27 |   0.3 |
| Practice Classes                                                            |          |        |  5:36 |   4.1 |
| COMPLETED Having trouble with Magit                                         |          |        |  3:15 |   2.4 |
| Discussing the task at hand                                                 |          |        | 18:55 |  14.0 |
| Fix the build                                                               |          |        |  0:28 |   0.3 |
| Searching for research material                                             |          |        |  3:45 |   2.8 |
...
| STARTED Attempt to use pointer, array and classes                           |          |        |  6:23 |   4.7 |
| Attempt to read and write in Employee                                       |          |        |  1:04 |   0.8 |
| STARTED Get Team Menu working                                               |          |        |  6:14 |   4.6 |
| Evaluate and learn from MC's work                                           |          |        |  1:03 |   0.8 |
| COMPLETED Fix the build                                                     |          |        |  0:30 |   0.4 |
| Use MC's work to strengthen mine                                            |          |        |  6:10 |   4.6 |
| Print complete list of teams                                                |          |        |  2:33 |   1.9 |
| Print players in team                                                       |          |        |  3:14 |   2.4 |
| Review Fridays work                                                         |          |        |  1:55 |   1.4 |
| Change if statements for carry selection                                    |          |        |  0:37 |   0.5 |
| Add data files for each team                                                |          |        |  2:33 |   1.9 |
| Watch YT videos on reading/writing                                          |          |        |  1:58 |   1.5 |
| Practice: create organised list file                                        |          |        |  1:34 |   1.2 |
| Attempt to create table using team data files                               |          |        |  5:46 |   4.3 |
| Review MC's sample game                                                     |          |        |  0:42 |   0.5 |
| Watch YT videos on Object Oriented Programming                              |          |        |  2:37 |   1.9 |
| Read Object-Oriented Programming (OOP)                                      |          |        |  1:55 |   1.4 |
| Create Diagram for football game                                            |          |        |  1:04 |   0.8 |
| Edit fgd.data                                                               |          |        |  0:44 |   0.5 |
