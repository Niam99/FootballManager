...
#+CAPTION: Clock summary at [2018-02-07 Wed 15:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 40:53   |       |      | 100.0 |
| Active                                                                      |         | 40:53 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:17 |  10.5 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |  13.4 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   2.4 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.8 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   5.4 |
| COMPLETED Read more on Classes                                              |         |       | 0:36 |   1.5 |
| COMPLETED Review and study MC's work                                        |         |       | 1:12 |   2.9 |
| CANCELLED Try an make changes using MC's work                               |         |       | 0:20 |   0.8 |
| COMPLETED Read about vectors to help add teams                              |         |       | 0:51 |   2.1 |
| STARTED Use Menu Classes for Teams menu                                     |         |       | 3:27 |   8.4 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   1.1 |
| Practice Classes                                                            |         |       | 5:36 |  13.7 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   7.9 |
| Discussing the task at hand                                                 |         |       | 2:21 |   5.7 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.6 |
| Searching for research material                                             |         |       | 0:41 |   1.7 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   4.0 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   4.4 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.8 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   4.2 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:16 |   3.1 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   1.6 |
| Review yesterdays work                                                      |         |       | 0:38 |   1.5 |
| Attempt to use pointer, array and classes                                   |         |       | 0:11 |   0.4 |
...
*** Attempt to use pointer, array and classes
