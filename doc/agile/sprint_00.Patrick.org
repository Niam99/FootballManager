...
#+CAPTION: Clock summary at [2018-02-14 Wed 14:28]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *71:01* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 71:01   |       |      | 100.0 |
| Active                                                                      |         | 71:01 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 5:50 |   8.2 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |   7.7 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   1.4 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.0 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   3.1 |
| COMPLETED Read more on Classes                                              |         |       | 0:36 |   0.8 |
| COMPLETED Review and study MC's work                                        |         |       | 1:12 |   1.7 |
| CANCELLED Try an make changes using MC's work                               |         |       | 0:20 |   0.5 |
| COMPLETED Read about vectors to help add teams                              |         |       | 0:51 |   1.2 |
| STARTED Use Menu Classes for Teams menu                                     |         |       | 5:14 |   7.4 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   0.6 |
| Practice Classes                                                            |         |       | 5:36 |   7.9 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   4.6 |
| Discussing the task at hand                                                 |         |       | 9:16 |  13.0 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.3 |
| Searching for research material                                             |         |       | 1:15 |   1.8 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   2.3 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   2.5 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.5 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   2.4 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:51 |   2.6 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   0.9 |
| Review yesterdays work                                                      |         |       | 0:38 |   0.9 |
| STARTED Attempt to use pointer, array and classes                           |         |       | 6:23 |   9.0 |
| Attempt to read and write in Employee                                       |         |       | 1:04 |   1.5 |
| STARTED Get Team Menu working                                               |         |       | 6:14 |   8.8 |
| Evaluate and learn from MC's work                                           |         |       | 1:03 |   1.5 |
| COMPLETED Fix the build                                                     |         |       | 0:30 |   0.7 |
| Use MC's work to strengthen mine                                            |         |       | 3:41 |   5.2 |
