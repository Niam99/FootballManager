...
#+CAPTION: Clock summary at [2018-02-20 Tue 13:27]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *92:08* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 92:08   |       |       | 100.0 |
| Active                                                                      |         | 92:08 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  7:41 |   8.3 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       |  5:28 |   5.9 |
| COMPLETED Create League.cpp/hpp                                             |         |       |  0:59 |   1.1 |
| COMPLETED Create game.cpp/hpp                                               |         |       |  0:43 |   0.8 |
| COMPLETED Create teams and players                                          |         |       |  2:12 |   2.4 |
| COMPLETED Read more on Classes                                              |         |       |  0:36 |   0.7 |
| COMPLETED Review and study MC's work                                        |         |       |  1:12 |   1.3 |
| CANCELLED Try an make changes using MC's work                               |         |       |  0:20 |   0.4 |
| COMPLETED Read about vectors to help add teams                              |         |       |  0:51 |   0.9 |
| STARTED Use Menu Classes for Teams menu                                     |         |       |  5:14 |   5.7 |
| Magit and attempting to fix first conflict                                  |         |       |  0:27 |   0.5 |
| Practice Classes                                                            |         |       |  5:36 |   6.1 |
| COMPLETED Having trouble with Magit                                         |         |       |  3:15 |   3.5 |
| Discussing the task at hand                                                 |         |       | 12:35 |  13.7 |
| Fix the build                                                               |         |       |  0:28 |   0.5 |
| Searching for research material                                             |         |       |  1:33 |   1.7 |
| COMPLETED Learn about pointers                                              |         |       |  1:39 |   1.8 |
| COMPLETED Attempt to use pointers                                           |         |       |  1:48 |   2.0 |
| COMPLETED Attempt to use pointers solo                                      |         |       |  0:20 |   0.4 |
| STARTED Learn more about data structures                                    |         |       |  1:43 |   1.9 |
| COMPLETED Watch Youtube tutorials                                           |         |       |  1:51 |   2.0 |
| COMPLETED Write pointer and array                                           |         |       |  0:39 |   0.7 |
| Review yesterdays work                                                      |         |       |  0:38 |   0.7 |
| STARTED Attempt to use pointer, array and classes                           |         |       |  6:23 |   6.9 |
| Attempt to read and write in Employee                                       |         |       |  1:04 |   1.2 |
| STARTED Get Team Menu working                                               |         |       |  6:14 |   6.8 |
| Evaluate and learn from MC's work                                           |         |       |  1:03 |   1.1 |
| COMPLETED Fix the build                                                     |         |       |  0:30 |   0.5 |
| Use MC's work to strengthen mine                                            |         |       |  6:10 |   6.7 |
| Print complete list of teams                                                |         |       |  2:33 |   2.8 |
| Print players in team                                                       |         |       |  3:14 |   3.5 |
| Review Fridays work                                                         |         |       |  0:44 |   0.8 |
| Change if statements for carry selection                                    |         |       |  0:37 |   0.7 |
| Add data files for each team                                                |         |       |  2:33 |   2.8 |
| Watch YT videos on reading/writing                                          |         |       |  1:58 |   2.1 |
| Practice: create organised list file                                        |         |       |  1:17 |   1.4 |
