...
#+CAPTION: Clock summary at [2018-02-19 Mon 20:13]
| <75>                                                                        |         |       |       |       |
| Headline                                                                    | Time    |       |       |     % |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| *Total time*                                                                | *88:23* |       |       | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+-------+-------|
| Stories                                                                     | 88:23   |       |       | 100.0 |
| Active                                                                      |         | 88:23 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       |  7:09 |   8.1 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       |  5:28 |   6.2 |
| COMPLETED Create League.cpp/hpp                                             |         |       |  0:59 |   1.1 |
| COMPLETED Create game.cpp/hpp                                               |         |       |  0:43 |   0.8 |
| COMPLETED Create teams and players                                          |         |       |  2:12 |   2.5 |
| COMPLETED Read more on Classes                                              |         |       |  0:36 |   0.7 |
| COMPLETED Review and study MC's work                                        |         |       |  1:12 |   1.4 |
| CANCELLED Try an make changes using MC's work                               |         |       |  0:20 |   0.4 |
| COMPLETED Read about vectors to help add teams                              |         |       |  0:51 |   1.0 |
| STARTED Use Menu Classes for Teams menu                                     |         |       |  5:14 |   5.9 |
| Magit and attempting to fix first conflict                                  |         |       |  0:27 |   0.5 |
| Practice Classes                                                            |         |       |  5:36 |   6.3 |
| COMPLETED Having trouble with Magit                                         |         |       |  3:15 |   3.7 |
| Discussing the task at hand                                                 |         |       | 12:12 |  13.8 |
| Fix the build                                                               |         |       |  0:28 |   0.5 |
| Searching for research material                                             |         |       |  1:15 |   1.4 |
| COMPLETED Learn about pointers                                              |         |       |  1:39 |   1.9 |
...
| COMPLETED Watch Youtube tutorials                                           |         |       |  1:51 |   2.1 |
| COMPLETED Write pointer and array                                           |         |       |  0:39 |   0.7 |
| Review yesterdays work                                                      |         |       |  0:38 |   0.7 |
| STARTED Attempt to use pointer, array and classes                           |         |       |  6:23 |   7.2 |
| Attempt to read and write in Employee                                       |         |       |  1:04 |   1.2 |
| STARTED Get Team Menu working                                               |         |       |  6:14 |   7.1 |
| Evaluate and learn from MC's work                                           |         |       |  1:03 |   1.2 |
| COMPLETED Fix the build                                                     |         |       |  0:30 |   0.6 |
| Use MC's work to strengthen mine                                            |         |       |  6:10 |   7.0 |
| Print complete list of teams                                                |         |       |  2:33 |   2.9 |
| Print players in team                                                       |         |       |  3:14 |   3.7 |
| Review Fridays work                                                         |         |       |  0:44 |   0.8 |
| Change if statements for carry selection                                    |         |       |  0:37 |   0.7 |
| Add data files for each team                                                |         |       |  2:33 |   2.9 |
| Watch YT videos on reading/writing                                          |         |       |  0:43 |   0.8 |
