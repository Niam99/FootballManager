...
#+CAPTION: Clock summary at [2018-03-06 Tue 09:27]
| <75>                                                                        |          |        |       |       |
| Headline                                                                    | Time     |        |       |     % |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| *Total time*                                                                | *135:05* |        |       | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| Stories                                                                     | 135:05   |        |       | 100.0 |
| Active                                                                      |          | 135:05 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |          |        | 10:38 |   7.9 |
| COMPLETED Understanding Some Essentials of MaGit                            |          |        |  5:28 |   4.0 |
| COMPLETED Create League.cpp/hpp                                             |          |        |  0:59 |   0.7 |
| COMPLETED Create game.cpp/hpp                                               |          |        |  0:43 |   0.5 |
| COMPLETED Create teams and players                                          |          |        |  2:12 |   1.6 |
| COMPLETED Read more on Classes                                              |          |        |  0:36 |   0.4 |
| COMPLETED Review and study MC's work                                        |          |        |  1:12 |   0.9 |
| CANCELLED Try an make changes using MC's work                               |          |        |  0:20 |   0.2 |
| COMPLETED Read about vectors to help add teams                              |          |        |  0:51 |   0.6 |
| COMPLETED Use Menu Classes for Teams menu                                   |          |        |  5:14 |   3.9 |
| COMPLETED Magit and attempting to fix first conflict                        |          |        |  0:27 |   0.3 |
| COMPLETED Practice Classes                                                  |          |        |  5:36 |   4.1 |
| COMPLETED Having trouble with Magit                                         |          |        |  3:15 |   2.4 |
| COMPLETED Discussing the task at hand                                       |          |        | 18:55 |  14.0 |
| COMPLETED Fix the build                                                     |          |        |  0:28 |   0.3 |
| COMPLETED Searching for research material                                   |          |        |  3:45 |   2.8 |
| COMPLETED Learn about pointers                                              |          |        |  1:39 |   1.2 |
| COMPLETED Attempt to use pointers                                           |          |        |  1:48 |   1.3 |
| COMPLETED Attempt to use pointers solo                                      |          |        |  0:20 |   0.2 |
| COMPLETED Learn more about data structures                                  |          |        |  1:43 |   1.3 |
| COMPLETED Watch Youtube tutorials                                           |          |        |  1:51 |   1.4 |
| COMPLETED Write pointer and array                                           |          |        |  0:39 |   0.5 |
| COMPLETED Review yesterdays work                                            |          |        |  0:38 |   0.5 |
| COMPLETED Attempt to use pointer, array and classes                         |          |        |  6:23 |   4.7 |
| COMPLETED Attempt to read and write in Employee                             |          |        |  1:04 |   0.8 |
| COMPLETED Get Team Menu working                                             |          |        |  6:14 |   4.6 |
| COMPLETED Evaluate and learn from MC's work                                 |          |        |  1:03 |   0.8 |
| COMPLETED Fix the build                                                     |          |        |  0:30 |   0.4 |
| COMPLETED Use MC's work to strengthen mine                                  |          |        |  6:10 |   4.6 |
| COMPLETED Print complete list of teams                                      |          |        |  2:33 |   1.9 |
| COMPLETED Print players in team                                             |          |        |  3:14 |   2.4 |
| COMPLETED Review Fridays work                                               |          |        |  1:55 |   1.4 |
| COMPLETED Change if statements for carry selection                          |          |        |  0:37 |   0.5 |
| COMPLETED Add data files for each team                                      |          |        |  2:33 |   1.9 |
| COMPLETED Watch YT videos on reading/writing                                |          |        |  1:58 |   1.5 |
| COMPLETED Practice: create organised list file                              |          |        |  1:34 |   1.2 |
| COMPLETED Attempt to create table using team data files                     |          |        |  5:46 |   4.3 |
| COMPLETED Review MC's sample game                                           |          |        |  0:42 |   0.5 |
| COMPLETED Watch YT videos on Object Oriented Programming                    |          |        |  2:37 |   1.9 |
| COMPLETED Read Object-Oriented Programming (OOP)                            |          |        |  1:55 |   1.4 |
| COMPLETED Create Diagram for football game                                  |          |        |  1:04 |   0.8 |
| COMPLETED Edit fgd.data                                                     |          |        |  0:44 |   0.5 |
| COMPLETED Fix football game diagram                                         |          |        |  0:37 |   0.5 |
| COMPLETED Setup classes based on diagram                                    |          |        |  0:45 |   0.6 |
| COMPLETED Use variables stored on data file                                 |          |        |  0:47 |   0.6 |
| COMPLETED Watch How to CREATE/INSTANTIATE OBJECTS in C++                    |          |        |  0:14 |   0.2 |
| COMPLETED Watch Inheritance and Class Hierarchies                           |          |        |  0:31 |   0.4 |
| COMPLETED Watch Object Lifetime in C++                                      |          |        |  0:13 |   0.2 |
| COMPLETED Read Object Oriented Memory Management                            |          |        |  0:15 |   0.2 |
| COMPLETED Find Information on creating objects                              |          |        |  2:02 |   1.5 |
| COMPLETED Attempt to create table using only epl.data                       |          |        |  2:47 |   2.1 |
| COMPLETED Add new team to epl.data to test table                            |          |        |  0:16 |   0.2 |
| COMPLETED Attempt to get W / L / D working in table                         |          |        |  6:53 |   5.1 |
| COMPLETED Research reading and storing ints from data file                  |          |        |  1:52 |   1.4 |
#+TBLFM: $5='(org-clock-time% @3$2 $2..$4);%.1f
#+end:


*** STARTED Sprint and product backlog grooming                       :story:
    CLOCK: [2018-03-05 Mon 16:54]--[2018-03-05 Mon 17:13] =>  0:19
...
*** COMPLETED Use Menu Classes for Teams menu
    CLOSED: [2018-03-06 Tue 09:24]
...
*** COMPLETED Magit and attempting to fix first conflict
    CLOSED: [2018-03-06 Tue 09:24]
    CLOCK: [2018-01-31 Wed 15:57]--[2018-01-31 Wed 16:24] =>  0:27
*** COMPLETED Practice Classes
    CLOSED: [2018-03-06 Tue 09:24]
...
*** COMPLETED Discussing the task at hand
    CLOSED: [2018-03-06 Tue 09:25]
    CLOCK: [2018-03-05 Mon 14:39]--[2018-03-05 Mon 15:10] =>  0:31
    CLOCK: [2018-03-05 Mon 11:50]--[2018-03-05 Mon 12:23] =>  0:33
    CLOCK: [2018-03-05 Mon 11:00]--[2018-03-05 Mon 11:14] =>  0:14
...
*** COMPLETED Searching for research material
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Learn more about data structures
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Review yesterdays work
    CLOSED: [2018-03-06 Tue 09:25]
    CLOCK: [2018-02-07 Wed 09:05]--[2018-02-07 Wed 09:43] =>  0:38

*** COMPLETED Attempt to use pointer, array and classes
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Attempt to read and write in Employee
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Get Team Menu working
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Evaluate and learn from MC's work
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Use MC's work to strengthen mine
    CLOSED: [2018-03-06 Tue 09:25]
...
- Output players
*** COMPLETED Print complete list of teams
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Print players in team
    CLOSED: [2018-03-06 Tue 09:25]
...
*** COMPLETED Watch YT videos on reading/writing
    CLOSED: [2018-03-06 Tue 09:26]
...
*** COMPLETED Practice: create organised list file
    CLOSED: [2018-03-06 Tue 09:26]
...
*** COMPLETED Attempt to create table using team data files
    CLOSED: [2018-03-06 Tue 09:26]
...
*** COMPLETED Read Object-Oriented Programming (OOP)
    CLOSED: [2018-03-06 Tue 09:26]
...
*** COMPLETED Create Diagram for football game
    CLOSED: [2018-03-06 Tue 09:26]
...
*** COMPLETED Attempt to create table using only epl.data
    CLOSED: [2018-03-06 Tue 09:27]
...
*** COMPLETED Add new team to epl.data to test table
    CLOSED: [2018-03-06 Tue 09:27]
    CLOCK: [2018-03-01 Thu 16:26]--[2018-03-01 Thu 16:42] =>  0:16

*** COMPLETED Attempt to get W / L / D working in table
    CLOSED: [2018-03-06 Tue 09:27]
    CLOCK: [2018-03-05 Mon 16:13]--[2018-03-05 Mon 16:54] =>  0:41
    CLOCK: [2018-03-05 Mon 15:29]--[2018-03-05 Mon 16:06] =>  0:37
    CLOCK: [2018-03-05 Mon 14:30]--[2018-03-05 Mon 14:39] =>  0:09
    CLOCK: [2018-03-05 Mon 12:43]--[2018-03-05 Mon 13:22] =>  0:39
    CLOCK: [2018-03-05 Mon 11:29]--[2018-03-05 Mon 11:48] =>  0:19
    CLOCK: [2018-03-05 Mon 11:14]--[2018-03-05 Mon 11:24] =>  0:10
    CLOCK: [2018-03-05 Mon 09:46]--[2018-03-05 Mon 10:26] =>  0:40
...
- Add losses and draws to table
- Add points to table using wins and draws to calculate

*** COMPLETED Research reading and storing ints from data file
    CLOSED: [2018-03-06 Tue 09:27]
