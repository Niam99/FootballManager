...
#+CAPTION: Clock summary at [2018-02-08 Thu 11:01]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *46:01* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 46:01   |       |      | 100.0 |
| Active                                                                      |         | 46:01 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:39 |  10.1 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |  11.9 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   2.1 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.6 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   4.8 |
| COMPLETED Read more on Classes                                              |         |       | 0:36 |   1.3 |
| COMPLETED Review and study MC's work                                        |         |       | 1:12 |   2.6 |
| CANCELLED Try an make changes using MC's work                               |         |       | 0:20 |   0.7 |
| COMPLETED Read about vectors to help add teams                              |         |       | 0:51 |   1.8 |
| STARTED Use Menu Classes for Teams menu                                     |         |       | 3:27 |   7.5 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   1.0 |
| Practice Classes                                                            |         |       | 5:36 |  12.2 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   7.1 |
| Discussing the task at hand                                                 |         |       | 3:32 |   7.7 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.5 |
| Searching for research material                                             |         |       | 0:41 |   1.5 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   3.6 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   3.9 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.7 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   3.7 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:16 |   2.8 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   1.4 |
| Review yesterdays work                                                      |         |       | 0:38 |   1.4 |
| STARTED Attempt to use pointer, array and classes                           |         |       | 3:46 |   8.2 |
