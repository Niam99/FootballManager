...
#+CAPTION: Clock summary at [2018-02-08 Thu 17:33]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *50:28* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 50:28   |       |      | 100.0 |
| Active                                                                      |         | 50:28 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 5:03 |  10.0 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |  10.8 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   1.9 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.4 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   4.4 |
| COMPLETED Read more on Classes                                              |         |       | 0:36 |   1.2 |
| COMPLETED Review and study MC's work                                        |         |       | 1:12 |   2.4 |
| CANCELLED Try an make changes using MC's work                               |         |       | 0:20 |   0.7 |
| COMPLETED Read about vectors to help add teams                              |         |       | 0:51 |   1.7 |
| STARTED Use Menu Classes for Teams menu                                     |         |       | 3:27 |   6.8 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   0.9 |
| Practice Classes                                                            |         |       | 5:36 |  11.1 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   6.4 |
| Discussing the task at hand                                                 |         |       | 4:40 |   9.2 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.5 |
| Searching for research material                                             |         |       | 0:41 |   1.4 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   3.3 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   3.6 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.7 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   3.4 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:34 |   3.1 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   1.3 |
| Review yesterdays work                                                      |         |       | 0:38 |   1.3 |
| STARTED Attempt to use pointer, array and classes                           |         |       | 6:23 |  12.6 |
