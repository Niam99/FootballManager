...
#+CAPTION: Clock summary at [2018-02-26 Mon 17:52]
| <75>                                                                        |          |        |       |       |
| Headline                                                                    | Time     |        |       |     % |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| *Total time*                                                                | *113:28* |        |       | 100.0 |
|-----------------------------------------------------------------------------+----------+--------+-------+-------|
| Stories                                                                     | 113:28   |        |       | 100.0 |
| Active                                                                      |          | 113:28 |       | 100.0 |
| STARTED Sprint and product backlog grooming                                 |          |        |  9:14 |   8.1 |
| COMPLETED Understanding Some Essentials of MaGit                            |          |        |  5:28 |   4.8 |
| COMPLETED Create League.cpp/hpp                                             |          |        |  0:59 |   0.9 |
| COMPLETED Create game.cpp/hpp                                               |          |        |  0:43 |   0.6 |
| COMPLETED Create teams and players                                          |          |        |  2:12 |   1.9 |
...
| STARTED Use Menu Classes for Teams menu                                     |          |        |  5:14 |   4.6 |
| Magit and attempting to fix first conflict                                  |          |        |  0:27 |   0.4 |
| Practice Classes                                                            |          |        |  5:36 |   4.9 |
| COMPLETED Having trouble with Magit                                         |          |        |  3:15 |   2.9 |
| Discussing the task at hand                                                 |          |        | 16:25 |  14.5 |
| Fix the build                                                               |          |        |  0:28 |   0.4 |
| Searching for research material                                             |          |        |  1:33 |   1.4 |
| COMPLETED Learn about pointers                                              |          |        |  1:39 |   1.5 |
| COMPLETED Attempt to use pointers                                           |          |        |  1:48 |   1.6 |
| COMPLETED Attempt to use pointers solo                                      |          |        |  0:20 |   0.3 |
| STARTED Learn more about data structures                                    |          |        |  1:43 |   1.5 |
| COMPLETED Watch Youtube tutorials                                           |          |        |  1:51 |   1.6 |
| COMPLETED Write pointer and array                                           |          |        |  0:39 |   0.6 |
| Review yesterdays work                                                      |          |        |  0:38 |   0.6 |
| STARTED Attempt to use pointer, array and classes                           |          |        |  6:23 |   5.6 |
| Attempt to read and write in Employee                                       |          |        |  1:04 |   0.9 |
| STARTED Get Team Menu working                                               |          |        |  6:14 |   5.5 |
| Evaluate and learn from MC's work                                           |          |        |  1:03 |   0.9 |
| COMPLETED Fix the build                                                     |          |        |  0:30 |   0.4 |
| Use MC's work to strengthen mine                                            |          |        |  6:10 |   5.4 |
| Print complete list of teams                                                |          |        |  2:33 |   2.2 |
| Print players in team                                                       |          |        |  3:14 |   2.8 |
| Review Fridays work                                                         |          |        |  1:13 |   1.1 |
| Change if statements for carry selection                                    |          |        |  0:37 |   0.5 |
| Add data files for each team                                                |          |        |  2:33 |   2.2 |
| Watch YT videos on reading/writing                                          |          |        |  1:58 |   1.7 |
| Practice: create organised list file                                        |          |        |  1:34 |   1.4 |
| Attempt to create table using team data files                               |          |        |  5:46 |   5.1 |
| Review MC's sample game                                                     |          |        |  0:42 |   0.6 |
| Watch YT videos on Object Oriented Programming                              |          |        |  2:37 |   2.3 |
| Read Object-Oriented Programming (OOP)                                      |          |        |  1:55 |   1.7 |
| Create Diagram for football game                                            |          |        |  1:04 |   0.9 |
| Edit fgd.data                                                               |          |        |  0:44 |   0.6 |
| Fix football game diagram                                                   |          |        |  0:37 |   0.5 |
| Setup classes based on diagram                                              |          |        |  0:45 |   0.7 |
