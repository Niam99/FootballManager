...
#+CAPTION: Clock summary at [2018-02-08 Thu 12:07]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 47:00   |       |      | 100.0 |
| Active                                                                      |         | 47:00 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:48 |  10.2 |
| COMPLETED Understanding Some Essentials of MaGit                            |         |       | 5:28 |  11.6 |
| COMPLETED Create League.cpp/hpp                                             |         |       | 0:59 |   2.1 |
| COMPLETED Create game.cpp/hpp                                               |         |       | 0:43 |   1.5 |
| COMPLETED Create teams and players                                          |         |       | 2:12 |   4.7 |
...
| STARTED Use Menu Classes for Teams menu                                     |         |       | 3:27 |   7.3 |
| Magit and attempting to fix first conflict                                  |         |       | 0:27 |   1.0 |
| Practice Classes                                                            |         |       | 5:36 |  11.9 |
| COMPLETED Having trouble with Magit                                         |         |       | 3:15 |   6.9 |
| Discussing the task at hand                                                 |         |       | 3:54 |   8.3 |
| COMPLETED Fix the build                                                     |         |       | 0:14 |   0.5 |
| Searching for research material                                             |         |       | 0:41 |   1.5 |
| COMPLETED Learn about pointers                                              |         |       | 1:39 |   3.5 |
| COMPLETED Attempt to use pointers                                           |         |       | 1:48 |   3.8 |
| COMPLETED Attempt to use pointers solo                                      |         |       | 0:20 |   0.7 |
| STARTED Learn more about data structures                                    |         |       | 1:43 |   3.7 |
| COMPLETED Watch Youtube tutorials                                           |         |       | 1:16 |   2.7 |
| COMPLETED Write pointer and array                                           |         |       | 0:39 |   1.4 |
| Review yesterdays work                                                      |         |       | 0:38 |   1.3 |
| STARTED Attempt to use pointer, array and classes                           |         |       | 4:14 |   9.0 |
