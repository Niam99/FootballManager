...
#+CAPTION: Clock summary at [2018-03-08 Thu 10:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *14:23* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 14:23   |       |      | 100.0 |
| Active                                                                      |         | 14:23 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   3.5 |
| COMPLETED Clone hedgr                                                       |         |       | 0:30 |   3.5 |
| COMPLETED Diagram                                                           |         |       | 1:00 |   7.0 |
| COMPLETED Create table standings classes                                    |         |       | 1:18 |   9.0 |
| COMPLETED Review                                                            |         |       | 0:20 |   2.3 |
| COMPLETED Create match classes                                              |         |       | 2:06 |  14.6 |
| COMPLETED Test Program                                                      |         |       | 0:23 |   2.7 |
| COMPLETED Discuss tasks                                                     |         |       | 0:19 |   2.2 |
| COMPLETED Add constructors to table class                                   |         |       | 0:29 |   3.4 |
| COMPLETED Add to table classes                                              |         |       | 4:56 |  34.3 |
| COMPLETED Fix table function                                                |         |       | 1:32 |  10.7 |
| COMPLETED Add setw to table                                                 |         |       | 1:00 |   7.0 |
