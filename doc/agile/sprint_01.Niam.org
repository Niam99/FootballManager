...
#+CAPTION: Clock summary at [2018-03-09 Fri 15:03]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *23:17* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 23:17   |       |      | 100.0 |
| Active                                                                      |         | 23:17 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   2.1 |
| COMPLETED Clone hedgr                                                       |         |       | 0:30 |   2.1 |
| COMPLETED Diagram                                                           |         |       | 1:00 |   4.3 |
| COMPLETED Create table standings classes                                    |         |       | 1:18 |   5.6 |
| COMPLETED Review                                                            |         |       | 0:20 |   1.4 |
| COMPLETED Create match classes                                              |         |       | 2:06 |   9.0 |
| COMPLETED Test Program                                                      |         |       | 0:23 |   1.6 |
| COMPLETED Discuss tasks                                                     |         |       | 0:19 |   1.4 |
| COMPLETED Add constructors to table class                                   |         |       | 0:29 |   2.1 |
| COMPLETED Add to table classes                                              |         |       | 4:56 |  21.2 |
| COMPLETED Fix table function                                                |         |       | 1:32 |   6.6 |
| COMPLETED Add setw to table                                                 |         |       | 1:00 |   4.3 |
| COMPLETED Discuss tasks                                                     |         |       | 0:35 |   2.5 |
| COMPLETED Analyse code                                                      |         |       | 2:21 |  10.1 |
| COMPLETED fix table bug                                                     |         |       | 1:09 |   4.9 |
| COMPLETED Test code                                                         |         |       | 1:00 |   4.3 |
| COMPLETED Fix quit bug                                                      |         |       | 1:00 |   4.3 |
| COMPLETED Fix match and add season                                          |         |       | 2:49 |  12.1 |
