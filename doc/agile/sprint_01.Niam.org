...
#+CAPTION: Clock summary at [2018-03-09 Fri 11:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Clone hedgr                                                       |         |       | 0:30 |   2.3 |
| COMPLETED Diagram                                                           |         |       | 1:00 |   4.5 |
| COMPLETED Create table standings classes                                    |         |       | 1:18 |   5.9 |
| COMPLETED Review                                                            |         |       | 0:20 |   1.5 |
| COMPLETED Create match classes                                              |         |       | 2:06 |   9.5 |
| COMPLETED Test Program                                                      |         |       | 0:23 |   1.7 |
| COMPLETED Discuss tasks                                                     |         |       | 0:19 |   1.4 |
| COMPLETED Add constructors to table class                                   |         |       | 0:29 |   2.2 |
| COMPLETED Add to table classes                                              |         |       | 4:56 |  22.3 |
| COMPLETED Fix table function                                                |         |       | 1:32 |   6.9 |
| COMPLETED Add setw to table                                                 |         |       | 1:00 |   4.5 |
| COMPLETED Discuss tasks                                                     |         |       | 0:35 |   2.6 |
| COMPLETED Analyse code                                                      |         |       | 2:21 |  10.6 |
| COMPLETED fix table bug                                                     |         |       | 1:09 |   5.2 |
| COMPLETED Test code                                                         |         |       | 1:00 |   4.5 |
| COMPLETED Fix quit bug                                                      |         |       | 1:00 |   4.5 |
| POSTPONED Fix match and add season                                          |         |       | 1:39 |   7.5 |
...
*** POSTPONED Fix match and add season
