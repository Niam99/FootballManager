...
#+CAPTION: Clock summary at [2018-03-12 Mon 16:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| COMPLETED Diagram                                                           |         |       | 1:00 |   3.1 |
| COMPLETED Create table standings classes                                    |         |       | 1:18 |   4.0 |
| COMPLETED Review                                                            |         |       | 0:20 |   1.0 |
| COMPLETED Create match classes                                              |         |       | 2:06 |   6.5 |
| COMPLETED Test Program                                                      |         |       | 0:23 |   1.2 |
| COMPLETED Discuss tasks                                                     |         |       | 0:19 |   1.0 |
| COMPLETED Add constructors to table class                                   |         |       | 0:29 |   1.5 |
| COMPLETED Add to table classes                                              |         |       | 4:56 |  15.3 |
| COMPLETED Fix table function                                                |         |       | 1:32 |   4.8 |
| COMPLETED Add setw to table                                                 |         |       | 1:00 |   3.1 |
| COMPLETED Discuss tasks                                                     |         |       | 0:35 |   1.8 |
| COMPLETED Analyse code                                                      |         |       | 2:21 |   7.3 |
| COMPLETED fix table bug                                                     |         |       | 1:09 |   3.6 |
| COMPLETED Test code                                                         |         |       | 1:00 |   3.1 |
| COMPLETED Fix quit bug                                                      |         |       | 1:00 |   3.1 |
| COMPLETED Fix match and add season                                          |         |       | 2:49 |   8.8 |
| COMPLETED Review                                                            |         |       | 1:45 |   5.4 |
| COMPLETED Go through last weeks work                                        |         |       | 1:00 |   3.1 |
| COMPLETED Discuss tasks                                                     |         |       | 0:40 |   2.1 |
| COMPLETED Create match fixtures                                             |         |       | 5:28 |  17.0 |
