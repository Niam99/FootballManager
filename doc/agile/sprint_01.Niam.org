...
#+CAPTION: Clock summary at [2018-03-13 Tue 15:00]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *37:05* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 37:05   |       |      | 100.0 |
| Active                                                                      |         | 37:05 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 0:30 |   1.3 |
| COMPLETED Clone hedgr                                                       |         |       | 0:30 |   1.3 |
| COMPLETED Diagram                                                           |         |       | 1:00 |   2.7 |
| COMPLETED Create table standings classes                                    |         |       | 1:18 |   3.5 |
| COMPLETED Review                                                            |         |       | 0:20 |   0.9 |
| COMPLETED Create match classes                                              |         |       | 2:06 |   5.7 |
| COMPLETED Test Program                                                      |         |       | 0:23 |   1.0 |
| COMPLETED Discuss tasks                                                     |         |       | 0:19 |   0.9 |
| COMPLETED Add constructors to table class                                   |         |       | 0:29 |   1.3 |
| COMPLETED Add to table classes                                              |         |       | 4:56 |  13.3 |
| COMPLETED Fix table function                                                |         |       | 1:32 |   4.1 |
| COMPLETED Add setw to table                                                 |         |       | 1:00 |   2.7 |
| COMPLETED Discuss tasks                                                     |         |       | 0:35 |   1.6 |
| COMPLETED Analyse code                                                      |         |       | 2:21 |   6.3 |
| COMPLETED fix table bug                                                     |         |       | 1:09 |   3.1 |
| COMPLETED Test code                                                         |         |       | 1:00 |   2.7 |
| COMPLETED Fix quit bug                                                      |         |       | 1:00 |   2.7 |
| COMPLETED Fix match and add season                                          |         |       | 2:49 |   7.6 |
| COMPLETED Review                                                            |         |       | 1:45 |   4.7 |
| COMPLETED Go through last weeks work                                        |         |       | 1:00 |   2.7 |
| COMPLETED Discuss tasks                                                     |         |       | 0:40 |   1.8 |
| COMPLETED Create match fixtures                                             |         |       | 5:28 |  14.7 |
| COMPLETED Review                                                            |         |       | 0:46 |   2.1 |
| Make match by using file                                                    |         |       | 4:09 |  11.2 |
