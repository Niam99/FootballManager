...
#+CAPTION: Clock summary at [2018-03-13 Tue 11:54]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *19:33* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 19:33   |       |      | 100.0 |
| Active                                                                      |         | 19:33 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 2:18 |  11.8 |
| STARTED Discussing task at hand                                             |         |       | 0:57 |   4.9 |
| STARTED Writing next task                                                   |         |       | 0:23 |   2.0 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   1.8 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   1.1 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   2.6 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   1.0 |
| STARTED Clean up files                                                      |         |       | 0:15 |   1.3 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   2.0 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   1.9 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   1.4 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   2.5 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.5 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   1.0 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   3.8 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   1.0 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |  10.6 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.7 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   7.2 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   4.2 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   2.3 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   1.3 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   3.0 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   5.5 |
| STARTED Attempt team management option                                      |         |       | 4:06 |  21.0 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   2.9 |
