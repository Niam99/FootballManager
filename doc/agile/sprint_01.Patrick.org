...
#+CAPTION: Clock summary at [2018-03-15 Thu 17:32]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 33:44   |       |      | 100.0 |
| Active                                                                      |         | 33:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:19 |  12.8 |
| STARTED Discussing task at hand                                             |         |       | 2:03 |   6.1 |
...
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   1.5 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   0.6 |
| STARTED Clean up files                                                      |         |       | 0:15 |   0.7 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   1.2 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   1.1 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   0.8 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   1.4 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   0.9 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   0.6 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   2.2 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   0.6 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |   6.1 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.4 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   4.2 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   2.4 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   1.3 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   0.7 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   1.7 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   3.2 |
| STARTED Attempt team management option                                      |         |       | 4:06 |  12.2 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   1.7 |
| COMPLETED Rename team to squad                                              |         |       | 3:07 |   9.2 |
| COMPLETED Read through MC's diagram changes                                 |         |       | 1:10 |   3.5 |
| COMPLETED Change team to club in diagram                                    |         |       | 0:22 |   1.1 |
| COMPLETED Create club.cpp/hpp                                               |         |       | 0:52 |   2.6 |
| STARTED Change correct lines in league.cpp                                  |         |       | 1:12 |   3.6 |
| STARTED Try print user display through team_management.cpp                  |         |       | 2:18 |   6.8 |
| STARTED Take some time to step back and look at project as a whole          |         |       | 0:56 |   2.8 |
| Attempt to get a menu of player under Team Management option                |         |       | 1:07 |   3.3 |
...
*** Attempt to get a menu of player under Team Management option
