...
#+CAPTION: Clock summary at [2018-03-12 Mon 13:26]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 15:38   |       |      | 100.0 |
| Active                                                                      |         | 15:38 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  11.8 |
| STARTED Discussing task at hand                                             |         |       | 0:52 |   5.5 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   2.2 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   1.4 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   3.3 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   1.3 |
| STARTED Clean up files                                                      |         |       | 0:15 |   1.6 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   2.6 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   2.3 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   1.7 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   3.1 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.9 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   1.3 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   4.7 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   1.3 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |  13.2 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.9 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   9.0 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   5.2 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   2.9 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   1.6 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   3.7 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   6.8 |
| STARTED Attempt team management option                                      |         |       | 1:26 |   9.2 |
| COMPLETED Go through NI's season changes                                    |         |       | 0:14 |   1.5 |
...
***
*** COMPLETED Go through NI's season changes
    CLOSED: [2018-03-12 Mon 12:22]
