...
#+CAPTION: Clock summary at [2018-03-14 Wed 13:08]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| *Total time*                                                                | *25:34* |       |      | 100.0 |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
| Stories                                                                     | 25:34   |       |      | 100.0 |
| Active                                                                      |         | 25:34 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:22 |  13.2 |
| STARTED Discussing task at hand                                             |         |       | 1:37 |   6.3 |
| STARTED Writing next task                                                   |         |       | 0:23 |   1.5 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   1.4 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   0.8 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   2.0 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   0.8 |
| STARTED Clean up files                                                      |         |       | 0:15 |   1.0 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   1.6 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   1.4 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   1.0 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   1.9 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.2 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   0.8 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   2.9 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   0.8 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |   8.1 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.5 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   5.5 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   3.2 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   1.8 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   1.0 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   2.3 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   4.2 |
| STARTED Attempt team management option                                      |         |       | 4:06 |  16.0 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   2.2 |
| STARTED Rename team to squad                                                |         |       | 3:07 |  12.2 |
| Read through MC's diagram changes                                           |         |       | 1:10 |   4.6 |
