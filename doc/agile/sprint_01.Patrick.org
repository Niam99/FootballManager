...
#+CAPTION: Clock summary at [2018-03-15 Thu 12:44]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 30:46   |       |      | 100.0 |
| Active                                                                      |         | 30:46 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 4:00 |  13.0 |
| STARTED Discussing task at hand                                             |         |       | 1:37 |   5.3 |
| STARTED Writing next task                                                   |         |       | 0:23 |   1.2 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   1.1 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   0.7 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   1.7 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   0.7 |
| STARTED Clean up files                                                      |         |       | 0:15 |   0.8 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   1.3 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   1.2 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   0.9 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   1.6 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.0 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   0.7 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   2.4 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   0.7 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |   6.7 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.4 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   4.6 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   2.7 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   1.5 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   0.8 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   1.9 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   3.5 |
| STARTED Attempt team management option                                      |         |       | 4:06 |  13.3 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   1.8 |
| COMPLETED Rename team to squad                                              |         |       | 3:07 |  10.1 |
| COMPLETED Read through MC's diagram changes                                 |         |       | 1:10 |   3.8 |
| COMPLETED Change team to club in diagram                                    |         |       | 0:22 |   1.2 |
| COMPLETED Create club.cpp/hpp                                               |         |       | 0:52 |   2.8 |
| STARTED Change correct lines in league.cpp                                  |         |       | 1:12 |   3.9 |
| STARTED Try print user display through team_management.cpp                  |         |       | 1:33 |   5.0 |
| STARTED Take some time to step back and look at project as a whole          |         |       | 0:35 |   1.9 |
