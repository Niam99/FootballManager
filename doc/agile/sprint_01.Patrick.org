...
#+CAPTION: Clock summary at [2018-03-12 Mon 15:36]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 16:30   |       |      | 100.0 |
| Active                                                                      |         | 16:30 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:51 |  11.2 |
| STARTED Discussing task at hand                                             |         |       | 0:52 |   5.3 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   2.1 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   1.3 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   3.1 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   1.2 |
| STARTED Clean up files                                                      |         |       | 0:15 |   1.5 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   2.4 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   2.2 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   1.6 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   2.9 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.8 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   1.2 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   4.4 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   1.2 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |  12.5 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.8 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   8.5 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   4.9 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   2.7 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   1.5 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   3.5 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   6.5 |
| STARTED Attempt team management option                                      |         |       | 1:58 |  11.9 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   3.4 |
