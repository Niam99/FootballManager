...
#+CAPTION: Clock summary at [2018-03-13 Tue 17:10]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 22:24   |       |      | 100.0 |
| Active                                                                      |         | 22:24 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 3:03 |  13.6 |
| STARTED Discussing task at hand                                             |         |       | 1:31 |   6.8 |
| STARTED Writing next task                                                   |         |       | 0:23 |   1.7 |
| COMPLETED Change variables from team to table                               |         |       | 0:21 |   1.6 |
| COMPLETED Remove commented code in team.cpp/hpp                             |         |       | 0:13 |   1.0 |
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   2.3 |
| COMPLETED Create user.hpp                                                   |         |       | 0:12 |   0.9 |
| STARTED Clean up files                                                      |         |       | 0:15 |   1.1 |
| COMPLETED Add constructors to user.hpp                                      |         |       | 0:24 |   1.8 |
| COMPLETED Add class to game.hpp                                             |         |       | 0:22 |   1.6 |
| COMPLETED Set next task                                                     |         |       | 0:16 |   1.2 |
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   2.2 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   1.3 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   0.9 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   3.3 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   0.9 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |   9.2 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.6 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   6.2 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   3.6 |
| COMPLETED Read through engine.cpp                                           |         |       | 0:27 |   2.0 |
| COMPLETED Look at NI's changes                                              |         |       | 0:15 |   1.1 |
| POSTPONED Create display method for match_day                               |         |       | 0:35 |   2.6 |
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   4.8 |
| STARTED Attempt team management option                                      |         |       | 4:06 |  18.3 |
| STARTED Go through NI's season changes                                      |         |       | 0:34 |   2.5 |
| STARTED Rename team to squad                                                |         |       | 1:32 |   6.8 |
