...
#+CAPTION: Clock summary at [2018-03-19 Mon 17:50]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 42:20   |       |      | 100.0 |
| Active                                                                      |         | 42:20 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 5:14 |  12.4 |
| STARTED Discussing task at hand                                             |         |       | 2:44 |   6.5 |
...
| COMPLETED Add new teams and players to epl.data                             |         |       | 0:31 |   1.2 |
...
| COMPLETED Clean game.cpp/hpp                                                |         |       | 0:29 |   1.1 |
| COMPLETED Add game.cpp                                                      |         |       | 0:18 |   0.7 |
| COMPLETED Add user.cpp                                                      |         |       | 0:12 |   0.5 |
| COMPLETED Clean game and user.hpp/cpp                                       |         |       | 0:44 |   1.7 |
| CANCELLED Look and attempt to fix "quit" bug                                |         |       | 0:12 |   0.5 |
| COMPLETED Study session on Constructors                                     |         |       | 2:04 |   4.9 |
| COMPLETED Review last push                                                  |         |       | 0:08 |   0.3 |
| COMPLETED Make users display from users.cpp                                 |         |       | 1:24 |   3.3 |
| STARTED Veiw MC's comment on commits                                        |         |       | 0:49 |   1.9 |
...
| COMPLETED Review last Fridays work                                          |         |       | 1:04 |   2.5 |
| STARTED Attempt team management option                                      |         |       | 4:06 |   9.7 |
| STARTED Go through NI's season changes                                      |         |       | 1:01 |   2.4 |
| COMPLETED Rename team to squad                                              |         |       | 3:07 |   7.4 |
| COMPLETED Read through MC's diagram changes                                 |         |       | 1:10 |   2.8 |
| COMPLETED Change team to club in diagram                                    |         |       | 0:22 |   0.9 |
| COMPLETED Create club.cpp/hpp                                               |         |       | 0:52 |   2.0 |
| STARTED Change correct lines in league.cpp                                  |         |       | 1:12 |   2.8 |
| STARTED Try print user display through team_management.cpp                  |         |       | 2:18 |   5.4 |
| STARTED Take some time to step back and look at project as a whole          |         |       | 0:56 |   2.2 |
| STARTED Attempt to get a menu of player under Team Management option        |         |       | 1:28 |   3.5 |
| STARTED Allow player to select their user and team from management option   |         |       | 6:12 |  14.6 |
